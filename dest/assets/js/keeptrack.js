...
var KeepTrack = function KeepTrack(element, options) {
  var this$1 = this;
...
KeepTrack.prototype.assignValues = function assignValues () {
...
KeepTrack.prototype.cacheItems = function cacheItems () {
...
KeepTrack.prototype.tick = function tick () {
...
KeepTrack.prototype.activateItem = function activateItem (inViewElm) {
    var this$1 = this;
...
KeepTrack.prototype.scrollFn = function scrollFn () {
  var st = utils.scrollTop();
...
KeepTrack.prototype.destroy = function destroy () {
  if (this.raf) {
